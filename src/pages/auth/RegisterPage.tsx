    ...
    <div className="min-h-screen bg-navy-950 flex flex-col items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-slate-500">Set up your nonprofit compliance hub</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-slate-500">
          ...
          <Link to="/login" className="text-navy-300 hover:text-navy-200 font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </motion.div>
